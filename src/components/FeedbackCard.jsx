...
const FeedbackCard = ({ id, content, name, title, img }) => (
  <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] border bg-[#7f7f7f70] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 hover:bg-[#dcdbdb65] hover:scale-110 duration-150 glowing-animation">
